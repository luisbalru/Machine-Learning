...
print("Imprimiendo el gráfico f-número de iteraciones")
plt.plot(range(0,k+1),data,'bo')
plt.xlabel('Número de iteraciones')
plt.ylabel('f(x,y)')
plt.title("Descenso de la imagen de f con el número de iteraciones")
plt.show()
input("\n--- Pulsa una tecla para continuar ---\n")
...
plt.title("Ein cometido en función de la tasa de aprendizaje")
plt.show()
...
plt.ylabel("Ein cometido")
plt.title("Ein cometido en función del tamaño del minibatch")
plt.show()
...
plt.title("Dataset generado para el experimento")
plt.show()
...
plt.xlabel("Número de iteraciones")
plt.ylabel("f(w)")
plt.title("Descenso de f respecto del número de iteraciones por el método de Newton")
plt.show()
...
plt.legend()
plt.ylabel("f(w)")
plt.title("Comparación con el método de Newton y Gradiente descendente")
plt.show()
print("Mínimo de f: " , f(w))
