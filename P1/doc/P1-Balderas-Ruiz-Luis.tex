...
\subsection{Caso 2}
Para $w_0=(0.1,0.1), \eta = 0.01$, el punto donde se alcanza el mínimo es $$w=(0.0492016140411 , 0.0489001338764)$$ El mínimo es $f(w) =0.191231609806$.
...
Además, las gráficas mostradas en los distintos casos indican que el método de Newton, ante funciones que son dos veces derivables y con derivada continua, tiene mucho mejor rendimiento que Gradiente Descendente, ya que aprovechamos la información de la curvatura de la función y no sólo de la pendiente de los hiperplanos tangentes (dependiendo de la dimensión).
\newpage
